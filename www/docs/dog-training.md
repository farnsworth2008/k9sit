...
We provide a free Initial Consultation for dog owners. We can meet at the home
of one of our trainers, at a dog park, in the client's home, or using a virtual
meeting platform.
...
<input type="hidden" name="item_name" value="30 Minute Private Training Session" />
...
<input type="hidden" name="cmd" value="_xclick" />
<input type="hidden" name="currency_code" value="USD" />
<input type="hidden" name="item_name" value="60 Minute Private Training Session" />
<input type="hidden" name="lc" value="US" />
<input type="hidden" name="no_note" value="0" />
<input type="hidden" name="shipping" value="0" />
...
Dogs must arrive no later then **1pm** on the **2nd** of July and leave no
...
The dog's owner is welcome to join the trainer for as much as 45 minutes per
day for training time if their schedule allows.
...
program you may work with your dog trainer to arrange home visits where your
spends a day and night at your home. The home visits do not count against the
block of training days. Some home visits simply extend the calendar period
associated with the training and are a great way to make it easier to
transition to and from the board and train experience.
...
We hope customers will not abuse our refund policy but we are willing to take a
risk on the portion of the costs related to dog training. We always do the best
work possible for any dog. We hope customers will see the improvements in their
dogs but also understand that no dog is ever perfect. The costs assocated with
boarding are not part of the potential refund amount and as such, if at the
end of a board and train engagement you feel totally disastified with the
training result you may request a refund of the training cost but no refund
will be provided for the cost of boarding the dog in the period.

We generally adjust the prices for our services on the **1st of each month**
based on a number of factors. For the most part the prices will be raised each
month. You can lock in the current prices by placing your deposit now.
